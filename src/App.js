    ...
    if (isDarkTheme) {
            ...
            <div>
                <div className={"linksCard"}>
                    <div style={{position: "absolute", left: "1050px"}}>
                        <MDBBtn size="lg" className='m-1' floating style={{backgroundColor: 'black'}}
                    ...
                    <Card style={{marginBottom: "20px", backgroundColor: "black", color: "white"}}>
                        ...
                        <ListGroup variant="flush">
                            <ListGroup.Item style={{
                                ...
                                <Button
                                    onClick={() => window.open("https://drive.google.com/file/d/1jHUQNt1KiLzHuUjtfSm-ThNO0z2mrqAg/view?usp=sharing", '_blank')}>Перейти</Button>
                            </ListGroup.Item>
                            <ListGroup.Item style={{
                                display: "flex",
                                alignItems: "center",
        ...
        return (
            <div>
                <div className={"linksCard"}>
                    <div style={{position: "absolute", left: "1050px"}}>
                        <MDBBtn size="lg" className='m-1' floating style={{backgroundColor: 'white', color: "black"}}
                                onClick={() => setIsDarkTheme(true)}>
                            <MDBIcon size="lg" fas icon='moon'/>
                        </MDBBtn>
                    </div>
